#!/usr/bin/env python3
"""
Validate a final checkpoint using the training script's own validation loop.
"""
...
# Load the checkpoint (choose λ=0.05)
lam = 0.05
...
print(f"\nλ={lam}: bpp={bpp:.4f}, PSNR={psnr:.2f} dB")

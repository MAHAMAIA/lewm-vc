#!/usr/bin/env python3
"""
FIXED Evaluation Script for LeWM-VC
- BPP calculation exactly matches training
- Quantization step: 4.0/255
- Sigma clamping: 0.01 to 10.0
- Hard quantization (no noise during eval)
"""
...
# ---------- Model definitions (matching training exactly) ----------
...
# ✅ FIXED: λ values and checkpoint directory
...
for lam in lambda_list:
    ...
    with torch.no_grad():
        for frame in tqdm(frames, desc=f"  Encoding λ={lam}"):
            ...
            # ✅ FIXED: Hard quantization (no noise)
...
csv_path = '/root/le-maia/benchmark_results/rd_curve_fixed.csv'

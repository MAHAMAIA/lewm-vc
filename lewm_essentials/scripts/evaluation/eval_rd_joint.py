#!/usr/bin/env python3
"""
Evaluate joint-trained checkpoints on the validation split (same as training).
Computes bpp, PSNR for each λ and compares with x265.
"""
...
csv_path = '/root/le-maia/benchmark_results/rd_curve_joint.csv'

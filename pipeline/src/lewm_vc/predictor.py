...
class LeWMPredictor(nn.Module):
    ...
    Input:
        context: List of 1-4 previous latent tensors, each [B, latent_dim, H//32, W//32]

    Output:
        mean: Predicted latent mean [B, latent_dim, H//32, W//32]
        std: Predicted latent std [B, latent_dim, H//32, W//32]
    """

...
class HyperpriorEntropy(nn.Module):
    ...
    Args:
        latent_dim: Number of latent channels (default: 32)
        hyper_channels: Number of hyperprior hidden channels (default: 128)
    ...
    def __init__(self, latent_dim: int = 32, hyper_channels: int = 128):
        super().__init__()
